...
local Library = {
    Theme = {
        Accent = {
            ...
            Color3.fromHex("#8FBC8F"), 
            Color3.fromHex("#4682B4"), 
            Color3.fromHex("#DAA520"), 
            Color3.fromHex("#FF6347")  
        },
        Notification = {
            Error = Color3.fromHex("#FF4C4C"), 
            Warning = Color3.fromHex("#FFA500")
        },
        Hitbox = Color3.fromHex("#2F4F4F"), 
        Friend = Color3.fromHex("#32CD32"), 
        Outline = Color3.fromHex("#1C1C1C"), 
        Inline = Color3.fromHex("#3C3C3C"),
        LightContrast = Color3.fromHex("#2E2E2E"), 
        DarkContrast = Color3.fromHex("#1A1A1A"),
        Text = Color3.fromHex("#F0F0F0"), 
        TextInactive = Color3.fromHex("#B0B0B0"), 
